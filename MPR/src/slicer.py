...
actor_axial.SetInputData(color_axial.GetOutput())
...
actor_coronal.SetInputData(color_coronal.GetOutput())
...
actor_sagittal.SetInputData(color_sagittal.GetOutput())
...
actor_oblique.SetInputData(color_oblique.GetOutput())
...
print(len(mpv_renderer), range(0,4))
for i in range(0,4):
